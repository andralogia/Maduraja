...
$sql_rt004 = "SELECT COUNT(*) AS count_rt004 FROM rt004";
$result_rt004 = $koneksi->query($sql_rt004);
$row_rt004 = $result_rt004->fetch_assoc();
$count_rt004 = $row_rt004['count_rt004'];
...
<head>
    ...
    <meta name="description" content="Maduraja - Dashboard Admin">
                        ...
                        <div style="border: 1px solid #ccc; border-radius: 5px; padding: 10px; background-color: #fff; width: 100%;">
                            <div style="display: flex; align-items: center;">
                                <div style="width: 50px; height: 50px; background-color: #ddd; border-radius: 50%; margin-right: 10px;">
                                    <img src="images/logo2.png" alt="Avatar" style="width: 100%; height: 100%; border-radius: 50%;">
                                </div>
                                <div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-flat-color-6">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            <span class="count"><?php echo $count_rt004 + $count_rt005; ?></span>
                                        </h3>
                        ...
                        <div>
                        <!-- Tombol reset -->
                        <button class="btn btn-danger" onclick="resetViewCount()">Reset Views</button>
