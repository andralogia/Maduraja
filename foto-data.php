        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="dashboard-004.php.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="foto-form-tambah.php" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="gallery">
                                    ...
                                    if (isset($_GET['Cari'])) {
                                        $data = mysqli_query($koneksi, "SELECT * FROM tb_foto WHERE keterangan LIKE '%" . $_GET['Cari'] . "%'");
                                    }
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<a href=\"foto-form-ubah.php?id={$row['id']}\" class=\"btn btn-outline-primary btn-sm fa fa-pencil mr-2\"></a>"; // Tombol Ubah
