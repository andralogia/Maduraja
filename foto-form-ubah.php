...
include "koneksi.php";
$id= $_GET ['id'];
$data= mysqli_query($koneksi, "SELECT * FROM tb_foto where id='$id'");
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="dasgboard-004.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="foto-data.php">Foto</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Ubah Data Foto</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="foto-ubah.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="foto" class="form-control-label">Foto</label></div>
                                        <div class="col-12 col-md-9">
                                            <?php if (isset($hasil['foto'])): ?>
                                                <img src="<?php echo $hasil['foto']; ?>" alt="<?php echo $hasil['keterangan']; ?>" width="200">
                                            <?php endif; ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="keterangan" name="keterangan" placeholder="Keterangan" class="form-control"
                                                value="<?php echo $hasil['keterangan']; ?>"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tanggal" class="form-control-label">Tanggal</label></div>
                                        <div class="col-12 col-md-9">
                                            <?php
                                            $tanggalValue = isset($hasil['tanggal']) ? date('Y-m-d', strtotime($hasil['tanggal'])) : '';
                                            ?>
                                            <input type="date" id="tanggal" name="tanggal" class="form-control-date" value="<?php echo $tanggalValue; ?>">
                                        </div>
                                    </div>
                                    <div class="float-right">
                                        <button type="submit" class="btn btn-primary" name="Simpan">Ubah</button>
                                        <a href="foto-data.php" class="btn btn-danger">Batal</a>
                                    </div>
                                    </form>
                                <?php } ?>
