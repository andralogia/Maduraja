                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="info-form-tambah.php" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-bold-500">
                                                    <a href="info-form-ubah.php?id=<?php echo $hasil['id'] ?>" class="btn btn-outline-primary btn-sm fa fa-pencil"></a>
                                                    <a onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini')" href="info-hapus.php?id=<?php echo $hasil['id'] ?>" class="btn btn-outline-danger btn-sm fa fa-trash"></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
