                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="info2-form-tambah.php" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    if (isset($_GET['Cari'])) {
                                        $data = mysqli_query($koneksi, "SELECT * FROM informasi WHERE pengumuman LIKE '%" . $_GET['Cari'] . "%'");
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-bold-500"><?php echo $hasil['pengumuman']; ?></td>
                                                <td class="text-bold-500">
                                                    <a href="info2-form-ubah.php?id=<?php echo $hasil['id'] ?>" class="btn btn-outline-primary btn-sm fa fa-pencil"></a>
                                                    <a onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini')" href="info2-hapus.php?id=<?php echo $hasil['id'] ?>" class="btn btn-outline-danger btn-sm fa fa-trash"></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                                    } else {
                                        echo '<tr><td colspan="3">Tidak ada pengumuman.</td></tr>';
                                    }
                                    ?>
                                    </tbody>
                                </table>
