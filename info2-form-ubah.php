                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="info2-data">Pengumuman</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <form action="info2-ubah.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div><input type="hidden" id="id" name="id" class="form-control" value="<?php echo $hasil['id'];?>"></div>
                                    <div class="col-12 col-md-12">
                                        <textarea name="pengumuman" id="pengumuman" rows="9" placeholder="Pengumuman..." class="form-control"><?php echo $hasil['pengumuman'];?></textarea>
                                    </div>
                                </div>

                                <div class="float-right">
                                    <button type="submit" class="btn btn-primary" name="Simpan">Ubah</button>
                                    <a href="info2-data.php" class="btn btn-danger">Batal</a>
                                </div>
                                </form>
                                <?php } ?>
