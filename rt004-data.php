                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="rt004-form-tambah.php" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                            include "koneksi.php";
                                            $no = 1;
                                            $data = mysqli_query($koneksi, "SELECT * FROM rt004");
                                            if (isset($_GET['Cari'])) {
                                                $data = mysqli_query($koneksi, "SELECT * FROM rt004 WHERE Regu LIKE '%" . $_GET['Cari'] . "%' OR Nama LIKE '%" . $_GET['Cari'] . "%'");
                                            }
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-bold-500">
                                                    <a href="rt004-form-ubah.php?id=<?php echo $hasil['id'] ?>"class="btn btn-outline-primary btn-sm fa fa-pencil"></a>
                                                    <a onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini')
                                                               " href="rt004-hapus.php?id=<?php echo $hasil['id'] ?>"class="btn btn-outline-danger btn-sm fa fa-trash"></a>
                                                </td>
                                            </tr>
                                        <?php
                                            }
