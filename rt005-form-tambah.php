                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="rt005-data.php">Regu Ronda</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Tambah Data Regu</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="rt005-simpan.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="form-check">
                                                <div class="radio">
                                                    <label for="Tugas" class="form-check-label ">
                                                        <input type="radio" id="Tugas" name="Tugas" value="Anggota" class="form-check-input">Anggota
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="Tugas" class="form-check-label ">
                                                        <input type="radio" id="Tugas" name="Tugas" value="Ketua" class="form-check-input">Ketua
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-check">
                                                <div class="radio">
                                                    <label for="Rumah" class="form-check-label ">
                                                        <input type="radio" id="Rumah" name="Rumah" value="Sewa" class="form-check-input">Sewa
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="Rumah" class="form-check-label ">
                                                        <input type="radio" id="Rumah" name="Rumah" value="Pribadi" class="form-check-input">Pribadi
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="RT" name="RT" placeholder="Disabled" readonly value="005" class="form-control"></div>
                                    </div>
                                    <div class="float-right">
                                        <button type="submit" class="btn btn-primary" name="Simpan">Simpan</button>
                                        <a href="rt005-data.php" class="btn btn-danger">Batal</a>
                                    </div>
                                    </form>
